...
htmlhelp_basename = "zfit-physicsdoc"
...
latex_documents = [
    (master_doc, "zfit-physics.tex", "zfit-physics Documentation", "zfit", "manual"),
]
...
man_pages = [(master_doc, "zfit-physics", "zfit-physics Documentation", [author], 1)]
